...
class VGG_FeatureExtractor(nn.Module):
    def __init__(self, input_channel, output_channel=512):
        ...
        self.ConvNet = nn.Sequential(
            ...
            nn.Conv2d(self.output_channel[3], self.output_channel[3], 2, 1, 0), nn.ReLU(True),  # 512x1x15
            nn.Dropout(p=0.3))
...
class VGG_FeatureExtractor_5(nn.Module):
    """
    A 5-layer VGG feature extractor, with input dimensions
    1 x 20 x 100 and output dimensions 64 x 1 x 7
    """
    def __init__(self, input_channel, output_channel=512):

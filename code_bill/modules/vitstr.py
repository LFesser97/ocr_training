...
def create_vitstr(num_tokens, model=None, checkpoint_path=''):
    ...
    vitstr=vitstr_tiny_patch10_100(drop_rate = 0.3,
                                   attn_drop_rate = 0.3,
                                   drop_path_rate=0.2)
...
@register_model
def vitstr_tiny_patch10_100(pretrained=False, **kwargs):
    kwargs['in_chans'] = 1
    model = ViTSTR(
        img_size=(20,100),patch_size=10, embed_dim=192, depth=12, num_heads=4, mlp_ratio=4, qkv_bias=True, **kwargs)

...
def train(opt):
    ...
    while(True):
        ...
        if (iteration + 1) % 1e+5 == 0:
            torch.save(
                model.state_dict(), f'./saved_models/{opt.exp_name}/iter_{iteration+1}.pt')
...
if __name__ == '__main__':
    ...
    parser.add_argument('--manualSeed', type=int, default=719, help='for random seed setting')
    ...
    parser.add_argument('--output_channel', type=int, default=64,
                        help='the number of output channel of Feature extractor')
    parser.add_argument('--hidden_size', type=int, default=32, help='the size of the LSTM hidden state')
    ...
    opt.train_data= 'crnndata/ICDAR_C1_training'
    opt.valid_data= 'crnndata/ICDAR_C1_testing'
    ...
    opt.TransformerModel='vitstr_tiny_patch10_100'
    # opt.TransformerModel='vitstr_tiny_patch16_224'

    if opt.Transformer==True:
        opt.FeatureExtraction = 'None'
        opt.SequenceModeling = 'None'
        opt.Prediction = 'None'

    opt.imgH,opt.imgW=20,100
